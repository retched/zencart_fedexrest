...
define('MODULE_SHIPPING_FEDEX_REST_TEXT_TITLE', 'FedEx'); 
define('MODULE_SHIPPING_FEDEX_REST_TEXT_DESCRIPTION', '<h2>FedEx REST API</h2><p>You will need to have registered an account with FedEx to use this module. Please see the README.md file.</p>');
